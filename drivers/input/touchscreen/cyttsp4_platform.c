...
#include <linux/Config_ECW.h>
/*Y536 parameters*/
static struct touch_settings cyttsp4_sett_ECW_Y536_param_regs = {
	.data = (uint8_t *)&cyttsp4_ECW_Y536_param_regs[0],
	.size = ARRAY_SIZE(cyttsp4_ECW_Y536_param_regs),
	.tag = 0,
};
static struct touch_settings cyttsp4_sett_ECW_Y536_param_size = {
	.data = (uint8_t *)&cyttsp4_ECW_Y536_param_size[0],
	.size = ARRAY_SIZE(cyttsp4_ECW_Y536_param_size),
	.tag = 0,
};
static struct cyttsp4_touch_config cyttsp4_ECW_Y536_ttconfig = {
	.param_regs = &cyttsp4_sett_ECW_Y536_param_regs,
	.param_size = &cyttsp4_sett_ECW_Y536_param_size,
	.fw_ver = ECW_Y536_ttconfig_fw_ver,
	.fw_vsize = ARRAY_SIZE(ECW_Y536_ttconfig_fw_ver),
};
...
/*Y536 parameters*/
static struct touch_settings cyttsp4_sett_ofilm_Y536_param_regs = {
	.data = (uint8_t *)&cyttsp4_ofilm_Y536_param_regs[0],
	.size = ARRAY_SIZE(cyttsp4_ofilm_Y536_param_regs),
	.tag = 0,
};
static struct touch_settings cyttsp4_sett_ofilm_Y536_param_size = {
	.data = (uint8_t *)&cyttsp4_ofilm_Y536_param_size[0],
	.size = ARRAY_SIZE(cyttsp4_ofilm_Y536_param_size),
	.tag = 0,
};
static struct cyttsp4_touch_config cyttsp4_ofilm_Y536_ttconfig = {
	.param_regs = &cyttsp4_sett_ofilm_Y536_param_regs,
	.param_size = &cyttsp4_sett_ofilm_Y536_param_size,
	.fw_ver = ofilm_Y536_ttconfig_fw_ver,
	.fw_vsize = ARRAY_SIZE(ofilm_Y536_ttconfig_fw_ver),
};
...
struct cyttsp4_sett_ttconfig_map cyttsp4_sett_ttconfig_map[] = {
		...
		[7]={
				.id = OFILM, 
				.product_family = "Y536-A1",
				.ttconfig_param = &cyttsp4_ofilm_Y536_ttconfig,
			},	
		[8]={
				.id = ECW, 
				.product_family = "Y536-A1",
				.ttconfig_param = &cyttsp4_ECW_Y536_ttconfig,
			},				
		[9]={
				.ttconfig_param = NULL,
			},
