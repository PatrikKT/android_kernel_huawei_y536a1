...
static struct device_attribute power_supply_attrs[] = {
	...
	POWER_SUPPLY_ATTR(running_test_soc),
	POWER_SUPPLY_ATTR(bat_sts),
	POWER_SUPPLY_ATTR(buck_sts),
	POWER_SUPPLY_ATTR(chg_sts),
	POWER_SUPPLY_ATTR(usb_sts),
	POWER_SUPPLY_ATTR(chg_ctrl),
